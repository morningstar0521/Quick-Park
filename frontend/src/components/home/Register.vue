  ...
  <div class="auth-page d-flex justify-content-center align-items-center">
    ...
    <div class="auth-box d-flex shadow-lg rounded">
      <div class="auth-left text-center p-4 d-flex flex-column justify-content-center align-items-center">
        ...
        <p class="text-white fw-light">Join us today! Create your account</p>
      </div>
      ...
      <div class="auth-right flex-fill p-5 d-flex flex-column justify-content-center">
        ...
        <form @submit.prevent="register">
          <div class="mb-3 input-group">
            ...
            <input type="text" v-model="fullName" class="form-control modern-input input-field" placeholder="Full Name" required />
          </div>
          <div class="mb-3 input-group">
          ...
          <div class="mb-3 input-group">
            ...
            <input type="text" v-model="address" class="form-control modern-input input-field" placeholder="Address" required />
          </div>
          <div class="mb-3 input-group">
            <span class="input-icon"><i class="fas fa-lock"></i></span>
            <input type="password" v-model="password" class="form-control modern-input input-field" placeholder="Password" required />
          </div>
          <button type="submit" class="btn btn-primary w-100 btn-lg btn-modern mt-3">Register</button>
        </form>
  ...
  methods: {
    async register() {
      try {
        ...
        const errorMsg = err.response?.data?.message || "Error while registering. Try again.";
        alert(errorMsg);
      }
    },
  },
